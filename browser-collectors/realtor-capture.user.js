// ==UserScript==
// @name         Quebec Capture - Realtor
// @namespace    https://localhost:3000
// @version      0.1
// @description  Browser-assisted Realtor capture for the local Quebec ingest pipeline.
...
(function () {
  ...
  const SOURCE = "realtor_ca";
  const LOCAL_BASE = "http://localhost:3000";
  const INGEST_URL = `${LOCAL_BASE}/api/scrape/realtor-ca/ingest`;
  ...
  panel.innerHTML = `
    <div style="font-weight:700;margin-bottom:8px">Realtor capture</div>
