...
const FSA_TO_CMA: Record<string, string> = {
  ...
  h2y: "Montreal", h3b: "Montreal", h2x: "Montreal", h3z: "Montreal", h4a: "Montreal",
  ...
  k1n: "Ottawa", k2p: "Ottawa", k1s: "Ottawa", k1y: "Ottawa", k2a: "Ottawa",
};
...
const FSA_TO_ZONE: Record<string, Record<string, string>> = {
  ...
  Vancouver: {
    v6b: "Zone 2 - English Bay", v6c: "Zone 3 - Downtown", v5v: "Zone 1 - West End/Stanley Park",
  ...
  Montreal: {
    ...
    h2x: "Zone 2 - Sud-Ouest/Verdun", h3z: "Zone 5 - Ct-des-Neiges/Mt-Royal/Outremont",
  },
  Toronto: {
  ...
  Ottawa: { k1n: "Zone 1 - Centretown", k2p: "Zone 2 - ByWard Market", k1s: "Zone 3 - Sandy Hill" },
};
